...
const TopMenu: React.FC<TopMenuProps> = ({...styleProps}) => {
    ...
    return <Flex flexDir='line' textAlign='center' {...styleProps}>
        ...
        <Flex mr="1vw"><SimpleText value={"Página Inicial"} fontWeight='bold' fontSize='1vw' onClick= {() => navigate("/paginal-inicial")}></SimpleText></Flex>
        <Flex mr="1vw"><SimpleText value={"Login"} fontWeight='bold' fontSize='1vw' onClick= {() => navigate("/cadastro")}></SimpleText></Flex>
    </Flex>
};
